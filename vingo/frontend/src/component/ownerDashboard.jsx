                    ...
                    <div className='flex justify-center items-center p-4 sm:p-6'>
                        <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
                            <div className=' flex flex-col items-center text-center'>
                                <FaUtensils className='text-red-500 w-16 h-16 sm:w-20 sm:h-20 mb-4 ' />
                                ...
                                <button onClick={() => navigate("/create-edit-shop")} className='bg-red-500 text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-2xl hover:bg-orange-600 transition-colors duration-200'>Get Started</button>
...

                {
                    ...
                    <div className='w-full flex flex-col items-center  gap-6  sm:px-6 '>
                        ...
                        <h1 className='text-2xl sm:text-3xl text-gray-900 flex items-center gap-3 mt-8 text-center'>
                            <FaUtensils className='text-red-500 w-14 h-14  ' />
                        ...
                        <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
                            <div className=' flex flex-col items-center text-center'>
                                ...
                                <p className='text-gray-600 mb-4 text-sm sm:text-base'>Share your delicious creation with our customers by  adding then into menu .</p>

                                <button onClick={() => navigate("/add-item")} className='bg-red-500 text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-2xl hover:bg-orange-600 transition-colors duration-200'>Add Food</button>
