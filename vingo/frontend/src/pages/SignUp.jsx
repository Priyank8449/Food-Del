        ...
        <div className='min-h-screen w-full flex items-center justify-center p-3 ' style={{ backgroundColor: bgColor, backgroundSize: "cover" }}>
            ...
            <div className={`0 rounded-xl  shadow-2xl w-full max-w-md p-4 border backdrop-blur-xl ]`}>
                ...
                <div className='mb-3'>
                    ...
                    <input className=' text-gray-600 rounded-lg  w-full p-1 border focus:outline-none focus:border-orange-500' onChange={(event) => setFullName(event.target.value)} value={fullName} type="text" placeholder='enter full  name' />
                </div>
                ...
                <div className='mb-3'>
                    ...
                    <input onChange={(event) => setMobile(event.target.value)} value={mobile} className=' text-gray-600 rounded-lg  w-full p-1 border focus:outline-none focus:border-orange-500' type="number" placeholder='enter your mobile number' />
                </div>
                {/* password */}
                <div className='mb-3'>
